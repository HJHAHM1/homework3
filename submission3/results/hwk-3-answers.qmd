...
load("C:/Users/hjust/OneDrive/Documents/GitHub/homework3/submission3/Hwk3_workspace.Rdata")
```
...
```{r} 
#| echo: false
#| label: fig-state-mean
#| fig-cap: Mean change in sales of the 5 states with the lowest increases in cigarette prices vs. the 5 states with the highest increases in cigarette prices

fig.sales_mean_line

```

Total sales decrease in response to price increases for both the top 5 and lowest 5 states. However, the top 5 states with the highest price increase have a sharper drop in sales than the lowest 5 states, which is the response we would expect with higher price increases for an elastic good. 
